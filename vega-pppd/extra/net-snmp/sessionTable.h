...
/* other required module components */
    /* *INDENT-OFF*  */
config_add_mib(VEGA-PPP-MIB)
config_require(VEGA-PPP-MIB/sessionTable/sessionTable_interface)
config_require(VEGA-PPP-MIB/sessionTable/sessionTable_data_access)
config_require(VEGA-PPP-MIB/sessionTable/sessionTable_data_get)
config_require(VEGA-PPP-MIB/sessionTable/sessionTable_data_set)
    /* *INDENT-ON*  */
