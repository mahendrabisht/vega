...
static const char *conf_history_file = "/var/lib/vega-ppp/history";
...
{
	if (telnet_send(cln, "vega-ppp version " VEGA_PPP_VERSION "\r\n", sizeof("vega-ppp version " VEGA_PPP_VERSION "\r\n")))
		return -1;
	return 0;
}
